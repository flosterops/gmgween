...
import { space, weight, fontSize, align, textAlign } from 'theme/functions.theme';
...
const Title: React.FC<ITitle> = ({
  ...
  <StyledTitle color={color} fontSize={fontSize} weight={weight} position={position} as={tagName} textAlign={textAlign} {...props}>
    {children}
  </StyledTitle>
);
